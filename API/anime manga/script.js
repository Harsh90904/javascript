const loaddata = async () => {
    const url = 'https://anime-characters.p.rapidapi.com/characters?traits%2FEye%20color=Black';
const options = {
	method: 'GET',
	headers: {
		'x-rapidapi-key': '90fe476f49mshe7a5233ff1d00d7p14501djsn3e8dd4ff67bd',
		'x-rapidapi-host': 'anime-characters.p.rapidapi.com'
	}
};
...
const load = (data) => {
    ...
    data.map((ele) => {
        ...
        des.textContent = ele.traits.Birthday;
